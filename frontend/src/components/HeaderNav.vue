<template>
  <header class="row justify-between items-center q-px-xl q-py-sm bg-white">
  ...
  <Transition>
    <div class="lt-md absolute full-width" style="background-color:rgba(255, 255, 255, 0.95)" v-show="showMenu">
