  ...
  <div class="row justify-between items-center q-px-lg q-py-sm bg-white">
    ...
    <nav>
      <ul class="gt-sm text-uppercase text-subtitle1 row" style="list-style: none" ref="desktopLinkList">
        <li><RouterLink class="q-py-sm q-px-md q-ml-xs" to="/">Störungen</RouterLink></li>
        <li><RouterLink class="q-py-sm q-px-md q-ml-xs" to="/statistik">Statistik</RouterLink></li>
        <li><RouterLink class="q-py-sm q-px-md q-ml-xs" to="/infos">Infos</RouterLink></li>
        <li><RouterLink class="q-py-sm q-px-md q-ml-xs" to="/impressum">Impressum</RouterLink></li>
      </ul>
  ...
  <Transition>
    <div class="z-max lt-md absolute full-width" style="background-color:rgba(255, 255, 255, 0.96)" v-show="showMenu">
      <ul class="text-uppercase text-subtitle1 column q-pa-none q-ma-none text-center" style="list-style: none" ref="mobileLinkList">
        <li><RouterLink class="q-py-lg full-width block" to="/">Störungen</RouterLink></li>
        <li><RouterLink class="q-py-lg full-width block" to="/statistik">Statistik</RouterLink></li>
        <li><RouterLink class="q-py-lg full-width block" to="/infos">Infos</RouterLink></li>
        <li><RouterLink class="q-py-lg full-width block" to="/impressum">Impressum</RouterLink></li>
      </ul>
    </div>
  </Transition>
</template>
